...
(function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        stop: function (cb) {
            this.stoppedAt = new Date(); //my addon
        ...
        _drawCountdownLabel: function (secondsElapsed) {
            ...
            //this.pen.fillText(secondsLeft.toHHMMSS() + 1, x, y);//my addon
            this.pen.fillStyle = this.settings.fontColor;
            //this.pen.fillText(secondsLeft, x, y);
            this.pen.fillText(secondsLeft.toHHMMSS(), x, y); //my addon
            if (drawLabel) {
